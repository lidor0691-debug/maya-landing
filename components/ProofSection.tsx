const waMessages = [
  ...
  { from: 'maya',   text: 'היי, בשמחה. איזה טיפול רלוונטי לך?' },
  { from: 'client', text: 'ניקוי פנים' },
  { from: 'maya',   text: 'מעולה. יש לנו תור פנוי ביום רביעי ב-18:00. מתאים?' },
  { from: 'client', text: 'כן' },
  { from: 'maya',   text: 'סגרתי לך תור. אשלח לך תזכורת לפני.' },
]
